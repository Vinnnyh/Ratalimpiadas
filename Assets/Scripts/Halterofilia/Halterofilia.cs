...
public class Halterofilia : MonoBehaviour
{
    ...
    // Modificado: Ahora usamos integers para los botones para coincidir con los par�metros del animator
    ...
    private void SetRandomButton()
    {
        ...
        buttonAnimator.SetInteger("ButtonState", currentButtonValue);
        Debug.Log("Nuevo bot�n: " + currentButton);
    }
    ...
    void controlMensajesPulsaciones()
    {
        ...
        else
        {
            ...
            if (Input.GetButtonDown(currentButton))
            {
                keyPressCount++;
                remainingTime++;
                // Opcional: Puedes agregar una animaci�n de "presionado correcto"
